public class FileCopy {
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 2 && args.length !=4) {
            System.out.println("Server-Eingabe: FileCopy server port [loss] [delay]");
            System.out.println("Client-Eingabe: FileCopy client host port file");
            System.exit(1);
        }
        ...
        switch (args[0]) {
            ...
            case "server":
                ...
                break;
            default:
                System.out.println(args[0] + " ist keine gültige Auswahl!");
        }
  }
